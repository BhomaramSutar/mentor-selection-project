	...
	<form role="form" action="Login" method="post">
			...
			<tr>
					...
					<td  class="col-md-6" align=left style="font-size: 20px;"><input type="radio"
						...
						<input
						type="radio" required name="rdo1" value="AdminInfo" id="Author" />Admin
						<input
	       ...
	       <tr>
		    ...
		    <td class="col-md-6"><input type="text"  name="txt_Uname" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required id="txt_Uname" placeholder="Enter Email-ID"></td>
		    </tr>
		
		    <tr>
			<td class="col-md-2"><label for="txt_Password">Password:</label></td>
			<td class="col-md-6"><input type="password" name="txt_Password" required id="txt_Password" placeholder="Enter Password"></td>
			</tr>
			<tr>
			...
			<a class="active" href="Registration.jsp" style="color: red;">Create New User</a></td>
			</tr>
			</table>
