...
<script>
	...
	String q1 = "select * from tblrating";
	...
	while(itr.hasNext()){ 
		...
		index.add(Mentoremail);
		double ratingscore=(double)rating/total;
		score.add(String.valueOf(df.format(ratingscore)));
	}
    
    /* int id=1;
    Statement stat1 = con.createStatement();
	String qrry1 = "select * from tblrating order by Rating_values desc";
