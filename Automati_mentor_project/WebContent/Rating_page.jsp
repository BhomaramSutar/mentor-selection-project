					...
					<nav class="navbar navbar-expand-lg">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-auto">
								...
								<li class="active"><a href="Rating_page.jsp">Rating</a></li>
			...
			<div style="width: 100%">
				<div style="width: 100%">
					<div style="width: 100%">
						...
						%>
						<form action="rating_page" method="post">
							<table border="1" style="border-color: white; width: 100%">
								...
								<%
									...
									String qrry1 = "select * from candidateregistration where Uemail='"
											+ email + "'";
								...
								<tr>
									...
									<td><input type="radio" style="border-color: gray;"
										name="txt_search" id="txt_search"
										value="<%=rs1.getString("Mentor_ID")%>" required="required" /> <%=rs1.getString("Mentor_ID")%>
									</td>
